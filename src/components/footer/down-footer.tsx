          ...
          <Row>
            <Col lg={3} md={6} xs={12} className=" footer-contact">
              ...
              <p>
                ...
                <br />
                <strong>Email:</strong> FrameShop@gmail.com
                <br />
              </p>
            </Col>
            ...
            <Col lg={4} md={6} className="footer-newsletter">
              ...
              <p>
                ...
                omnis sed perspiciatis possimus placeat amet facilis tempora
                nobis necessitatibus quis quam in maiores, enim esse, architecto
                eius recusandae earum dignissimos?
              </p>
